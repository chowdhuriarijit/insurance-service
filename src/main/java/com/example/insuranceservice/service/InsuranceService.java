...
import com.example.insuranceservice.exception.PersonNotFoundException;
...
public class InsuranceService {
    ...
    public Map<String, Object> getInsuranceDetails(String personId) {
        ...
        if (insurances.isEmpty()) {
            throw new PersonNotFoundException("No insurance data found for personId: " + personId);
        }
        ...
        if (hasCarInsurance) {
            try {
                ...
                throw new RuntimeException("Failed to fetch vehicle information", ex);
            }
        }
